...
export function requestAvatarStateTransition(input: {
  ...
  if (
    !currentDefinition.interruptible &&
    requestedDefinition.priority < currentDefinition.priority
  ) {
