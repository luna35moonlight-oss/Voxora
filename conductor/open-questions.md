...
| OQ-PCR-002 | Pet Card Race balance values — track length 11, station steps 0/4/7/9, 2 s rival tick, combination step values, score weights? (owner-stated rules — three races, 3/3/3/4 deals, five second wait, fast 10/J/Q/K, combinations, jokers, five tactic cards — are not in question) | PROVISIONAL — OWNER CONFIRMATION REQUESTED (see `pet-card-race.md` §7) |
